...
The table is filled based on information from each company's landing page.  
...
| <details><summary>[WisdomAI](https://www.wisdom.ai/)</summary>Agentic analytics platform for enterprises: chat, agents, and AI dashboards over your databases and documents, grounded in a governed Adaptive Context Engine.</details> |  |  |  |  |  | ✅ | ✅ |  |  |  |
| <details><summary>[Bruin](https://getbruin.com/)</summary>Open-core data platform with an AI Data Analyst: ask questions in plain English in Slack or Teams, answered from live pipelines, metadata, and a semantic layer.</details> | ✅ | ✅ | ✅ | ✅ |  | ✅ | ✅ | ✅ |  | Looker, Tableau, Mode |
| <details><summary>[Wren AI](https://getwren.ai/)</summary>Open-source agentic GenBI platform: ask questions in plain English and get governed SQL, charts, and dashboards across 20+ data sources. Self-service in Slack and Teams.</details> | ✅ | ✅ | ✅ | ✅ |  | ✅ | ✅ |  |  |  |
| <details><summary>[Cube D3](https://cube.dev/agentic-ai)</summary>Agentic analytics from Cube, built on its universal semantic layer: Analytics Chat, an in-thread Slack agent, and AI integrations via the Cube MCP server.</details> |  |  | ✅ |  |  | ✅ | ✅ |  |  |  |
| <details><summary>[Hex](https://hex.tech/)</summary>AI analytics platform uniting agentic notebooks (Notebook Agent), conversational self-serve (Threads), and governed data apps on endorsed semantic models.</details> | ✅ |  | ✅ |  |  | ✅ | ✅ | ✅ |  |  |
...
| <details><summary>[ChatGPT (Data Analysis)](https://chatgpt.com/)</summary>Upload files and analyze data with ChatGPT's built-in data analysis: Python code interpreter, charts, and insights. Replaces the retired standalone Data Analyst GPT.</details> | ✅ |  |  |  |  |  |  | ✅ | ✅ |  |
...
| <details><summary>[Langchain SQL Agent](https://python.langchain.com/docs/tutorials/sql_qa/)</summary>LangChain has a SQL Agent which provides a more flexible way of interacting with SQL Databases than a chain.</details> |  | ✅ |  |  |  | ✅ |  | ✅ |  |  |
...
## Models Optimized for Text 2 SQL (historical)

Frontier general-purpose LLMs have since replaced specialized text-to-SQL models; kept for reference.
